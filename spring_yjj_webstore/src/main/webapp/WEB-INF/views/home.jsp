    ...
    <section class="container py-5">
        ...
        <div class="row">
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="${pageContext.request.contextPath}/resources/uiux/img/category_img_01.jpg" class="rounded-circle img-fluid border"></a>
                <h5 class="text-center mt-3 mb-3">가방</h5>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="${pageContext.request.contextPath}/resources/uiux/img/category_img_02.jpg" class="rounded-circle img-fluid border" ></a>
                <h2 class="h5 text-center mt-3 mb-3">시계</h2>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="${pageContext.request.contextPath}/resources/uiux/img/category_img_03.jpg" class="rounded-circle img-fluid border "></a>
                <h2 class="h5 text-center mt-3 mb-3">주얼리</h2>
            </div>
        </div>
    </section>
        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="${pageContext.request.contextPath}/resources/uiux/img/feature_prod_01.jpg" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                               <li>
                                ...
                                <li class="text-muted text-right">6,100,000 ₩ </li>
                            </ul>
                            <a href="shop-single.html" class="h2 text-decoration-none text-dark">코코핸들</a>
                            <p class="card-text">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="${pageContext.request.contextPath}/resources/uiux/img/feature_prod_02.jpg" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <li>
                                ...
                                <li class="text-muted text-right">11,420,000 ₩</li>
                            </ul>
                            <a href="shop-single.html" class="h2 text-decoration-none text-dark">서브마리너</a>
                            <p class="card-text">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="${pageContext.request.contextPath}/resources/uiux/img/feature_prod_03.jpg" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <li>
                                ...
                                <li class="text-muted text-right">8,650,000 ₩</li>
                            </ul>
                            <a href="shop-single.html" class="h2 text-decoration-none text-dark">LOVE 브레이슬릿</a>
                            <p class="card-text">
...
<link href="https://fonts.googleapis.com/css2?family=Cinzel:wght@500&display=swap" rel="stylesheet">
                ...
                <div class="col-md-4 pt-5">
					...
					<ul class="list-unstyled text-light footer-link-list">
						...
						<li><a class="text-decoration-none" href="#">회사위치</a></li>
